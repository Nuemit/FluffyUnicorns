...
% Olecranon = Ellenbogenhöcker
% Syndesmose = (Unechtes Gelenk)
% Partella = Sesambein
% Malleolen
% Membrana Interossea
% Ossa Tarsalia =  Fußwurzelknochen
% Ossa Metatarsalia = Mittelfußknochen
% Caput Ossis Metatarsal’s = Der Kopf des Mittelfußknochens
% Ossa = Die Knochen
% Os = Der Knochen
\newpage
\section{Zellen}
